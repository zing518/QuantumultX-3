...
[task_local]
#注销京东会员卡
55 23 * * * https://raw.githubusercontent.com/Kyle0816/QuantumultX/main/JS/jd_unbind_nickName.js, tag=注销京东会员卡, enabled=true
 */
...
async function unsubscribeCards() {
  ...
  if (push_lena == 0) {
    ...
    await notify.sendNotify(`京东会员卡注消链接`, `【京东账号${$.index}】${$.nickName}\n${tg_text}`);
  } else {
    let step = 0
